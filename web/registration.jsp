...
<div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html" ><font face="Georgia, Times New Roman, Times, serif"><strong><font color="#42AFDF">T</font></strong>'EST<strong><font color="#000000">P</font></strong>IER</font>
            </a>
        </div>
    ...
    <div id="page-wrapper" class="page-wrapper-cls">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <input  type="text" value = "" pattern="\d*" class="form-control" id="phone" placeholder="Enter Cell Number" />
                        </div>
                        <div class="form-group">
                            ...
                            <option value="T">Tester</option></select>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <p>All content, including avatars , are all subject to our Terms & Conditions. By registering an account, you attest that you have read and agree to our Terms of Use and Privacy & Security Policy.<br>Terms & Conditions | Rules of Engagement | Privacy & Security Policy</p>
